...
# Pass a number of your choosing (using input a good idea) and
...
# Create a third function that takes a single greeting parameter
# (ex. Howdy) and returns a string using the passed in greeting and
# 'World' (ex. Howdy World!)
